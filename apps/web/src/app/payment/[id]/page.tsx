...
const payment = () => {
  ...
  return (
    <article className="m-2 px-4">
      ...
      <h1 className="text-black text-base mb-8 text-center">
        Please take a moment to review your ticket.
      </h1>
      <div className="flex flex-col">
        <div className="relative h-1/2 overflow-x-auto w-full border border-gray-400 rounded-lg">
        ...
        <div className="flex flex-col items-center space-y-8">
          <h1 className="text-black font-bold text-lg mt-10 text-cente">
            PAYMENT METHOD
          </h1>
          ...
          <label className="cursor-pointer inline-flex items-center">
            ...
            />
            <div className="text-gray-900 bg-white border font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-800 dark:bg-white dark:border-gray-700 dark:text-gray-900 dark:hover:bg-gray-200 peer-checked:border-red-500 peer-checked:ring-2 peer-checked:ring-red-400">
              <svg
                aria-hidden="true"
          ...
          >
            ...
            <Modal.Body>
              <div className="text-center">
                <h1 className="font-bold text-lg">Booking Success</h1>
                <hr className="my-4 border-t-2 " />
                <BiCheckCircle className="mx-auto mb-4 h-14 w-14 text-red-400 " />
