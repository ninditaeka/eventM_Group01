...
export default function Dashboard() {
  ...
  return (
    <div>
      <div>
        <nav className="fixed top-0 z-50 w-full bg-red-400 border-b border-gray-200 dark:bg-pink-600 dark:bg-pink-600">
        ...
        <main className="flex-1">
          <div className="w-fit mx-auto p-6 sm:ml-64 mt-16">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="font-semibold">
                    Point Balance{' '}
                    <span className="text-gray-500">(exp 3 months later)</span>
                  </label>
                  <input
                    type="text"
                    value="10,000"
                ...
                <div>
                  <label className="font-semibold">Referral Code</label>
                  <input
                    type="text"
                    value="987654321"
                    readOnly
              ...
              <div className=" p-4 rounded-lg text-center">
                ...
                <div className="mt-4 p-4 bg-yellow-300 rounded-lg">
                  <p className="font-bold text-lg">Discount Coupon</p>
                  <p className="text-xl">10% OFF</p>
                </div>
              </div>
            </div>
          </div>
